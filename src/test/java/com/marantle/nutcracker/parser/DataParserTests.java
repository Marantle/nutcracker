...
public class DataParserTests {
    ...
    private static Logger log = Logger.getLogger(DataParserTests.class);
    ...
    public static void loadAndPrintFile() throws URISyntaxException, IOException {
        ...
        log.error(String.format("Testing data: %s ", data));
    ...
    public void parsedDataSizeShouldMatchRawData() throws FileNotFoundException {
        repo.listWorkShifts().forEach(log::info);
    ...
    public void person1DataShouldMatchExpected() {
        ...
        Salary salary = getSalaryForPerson(personId, dateToCheck);
        ...
        assertEquals("16:00 to 18:00 hours of regular work => 2", expectedRegularHours,
                actualRegularHours);
        double actualRegularSalary = salary.getRegularSalary().doubleValue();
        ...
        assertEquals("18:00 to 24:00 of evening work => 6", expectedEveningHours,
                actualEveningHours);
        double actualEveningSalary = salary.getEveningSalary().doubleValue();
        ...
        double actualOvertimeSalary = salary.getOvertimeSalary().doubleValue();
        ...
        double actualTotalSalary = salary.getTotalSalary().doubleValue();
    ...
    private Salary getSalaryForPerson(int personId, LocalDate dateToCheck) {
        return repo.findSalary(personId, dateToCheck);
    }
